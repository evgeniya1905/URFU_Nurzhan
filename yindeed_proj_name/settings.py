"""
Django settings for yindeed_proj_name project.
...
SECRET_KEY = 'dkimvafipmvwpioermvwpeivmpeoiew'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*'
                 ] #or it wont load on internet
...
ROOT_URLCONF = 'yindeed_proj_name.urls'
...
WSGI_APPLICATION = 'yindeed_proj_name.wsgi.application'
