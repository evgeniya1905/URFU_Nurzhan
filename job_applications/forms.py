...
class JobApplicationForm(forms.ModelForm):
    ...
    def clean_resume(self):
        ...
        if resume:
            # Проверьте, не превышает ли размер файла 10 мегабайт
            if resume.size > 10 * 1024 * 1024:  # 10 мегабайт в байтах
                raise forms.ValidationError("File size cannot exceed 10 megabytes.")

            # Проверьте, не является ли файл PDF-файлом с расширением имени файла
